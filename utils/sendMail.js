...
const sendMail = async (to, url, text) => {
                            ...
                            <td style="width:100%;background-color:#fff;padding:30px 0" width="100%;">
                                <table class="m_-8967697135683607433width-full" width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="Margin:0 auto;max-width:600px">
                                    <tbody><tr>
                                        ...
                                        <tr>
                                            <td style="padding:10px 50px 0px 50px;text-align:left;vertical-align:middle;font-family:ProximaNova-Regular,Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif;font-size:18px;color:#424242;line-height:24px;text-align:center">
                                                Nhấp vào nút bên dưới để đặt lại mật khẩu của bạn! Liên kết này sẽ hết hạn sau 30 phút.                                                
                                            </td>
                                        </tr>
                                         <tr>
                                            <td style="padding:10px 50px 0px 50px;text-align:left;vertical-align:middle;font-family:ProximaNova-Regular,Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif;font-size:18px;color:#424242;line-height:24px;text-align:center">                                                
    ...
    border-radius: 25px;">Đặt lại mật khẩu</a>                                               
                                            </td>
                                        </tr>
                                         <tr>
                                            <td style="padding:10px 50px 0px 50px;text-align:left;vertical-align:middle;font-family:ProximaNova-Regular,Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif;font-size:18px;color:#424242;line-height:24px;text-align:center">                                                                                                
                                                Nếu bạn không thể nhấp vào nút ở trên, hãy dán liên kết này vào trình duyệt của bạn                                    
                                            </td>
                                        </tr>
                                         <tr>
                                            <td style="padding:10px 50px 0px 50px;text-align:left;vertical-align:middle;font-family:ProximaNova-Regular,Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif;font-size:18px;color:#424242;line-height:24px;text-align:center">                                                                                      
...
/* <table id="m_-8967697135683607433bodyTable" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f5f5f3" style="background-color:#f5f5f3">
    <tbody><tr>
        <td width="100%" style="padding:0 10px 30px 10px">
            <table class="m_-8967697135683607433width-full" width="100%" cellpadding="0" cellspacing="0" border="0" style="Margin:0 auto;max-width:600px">
                <tbody><tr>
                    <td style="padding:30px 0 30px 0;text-align:center">
                        <img src="https://ci4.googleusercontent.com/proxy/bmp-_-NykgJ3zjN-fF89G93AZSoVIHt9Tb5JeLR4bW5N9q4X202CqYow_Z_GXErJqhhKLWDh2Olz8GYWDgnbvg5ax5faiw=s0-d-e1-ft#https://static.classdojo.com/img/classdojo-logo.png" style="display:block;Margin:0 auto;font-size:19px;color:#424242;line-height:28px;font-family:ProximaNova-Semibold,Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif" width="158" alt="ClassDojo Logo" class="CToWUd">
              </td>
            </tr>
          </tbody></table>
                <table class="m_-8967697135683607433width-full" width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="Margin:0 auto;max-width:600px">
                    <tbody><tr><td><div style="display:none"></div>
                            ...
                            <td style="width:100%;background-color:#fff;padding:30px 0" width="100%;">
                                <table class="m_-8967697135683607433width-full" width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="Margin:0 auto;max-width:600px">
                                    <tbody><tr>
                                        <td style="padding:0 50px 0px 50px;text-align:left;vertical-align:middle;font-family:ProximaNova-Semibold,Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif;font-size:24px;color:#424242;line-height:29px;text-align:center">
                                            Bạn được mời tham gia lớp học của con bạn trên ClassDojo
                  </td>
                                    </tr>
                                        <tr>
...
/* <div style="max-width: 700px; margin:auto; border: 10px solid rgb(0, 174, 239); padding: 50px 20px; font-size: 110%;">
    <h2 style="text-align: center; text-transform: uppercase;color: rgb(0, 174, 239);font-family: 'Saira', sans-serif;">Chào mừng đến với <span>ChildiT</span></h2>
    <p style="font-family: 'Saira', sans-serif;">
        Chỉ cần nhấp vào nút bên dưới để xác thực địa chỉ email của bạn.
            </p>

    <a href=${url} style="background: rgb(0, 174, 239); text-decoration: none; color: white; padding: 10px 30px; margin: 10px 0; display: inline-block;font-family: 'Saira', sans-serif;">${text}</a>

    <p style="font-family: 'Saira', sans-serif;">Nếu nút không hoạt động vì một hoài lý do nào đó, Hãy nhấn nào link bên dưới</p>

    <div style="font-family: 'Saira', sans-serif;">${url}</div>
    <img src="https://res.cloudinary.com/dxnfxl89q/image/upload/v1622275047/Classdojo/Capture_eijzuf.png" alt style="width:100%;object-fit:cover;"> </img>
</div> */